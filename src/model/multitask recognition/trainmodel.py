...
participant_dropout2 = tf.keras.layers.Dropout(0.4)(participant_dense2)
...
# plt.figure()
# plt.title('Activity Losses')
# plt.xlabel('Epoch Number')
# plt.ylabel('Activity Loss')
# plt.plot(training_history.history['activity_output_loss'], label='training set')
# plt.plot(training_history.history['val_activity_output_loss'], label='validation set')
# plt.legend()
# plt.show(block=False)

# # Plot accuracy for activity recognition
# plt.figure()
# plt.title('Activity Accuracies')
# plt.xlabel('Epoch Number')
# plt.ylabel('Activity Accuracy')
# plt.plot(training_history.history['activity_output_accuracy'], label='training set')
# plt.plot(training_history.history['val_activity_output_accuracy'], label='validation set')
# plt.legend()
# plt.show()

# # Plot loss for participant recognition
# plt.figure()
# plt.title('Participant Losses')
# plt.xlabel('Epoch Number')
# plt.ylabel('Participant Loss')
# plt.plot(training_history.history['participant_output_loss'], label='training set')
# plt.plot(training_history.history['val_participant_output_loss'], label='validation set')
# plt.legend()
# plt.show(block=False)

# # Plot accuracy for participant recognition
# plt.figure()
# plt.title('Participant Accuracies')
# plt.xlabel('Epoch Number')
# plt.ylabel('Participant Accuracy')
# plt.plot(training_history.history['participant_output_accuracy'], label='training set')
# plt.plot(training_history.history['val_participant_output_accuracy'], label='validation set')
# plt.legend()
# plt.show()
# ----------------------------------------------------------------------------
# Save Model
model_name = 'multitask_recognition_cnn.h5'
